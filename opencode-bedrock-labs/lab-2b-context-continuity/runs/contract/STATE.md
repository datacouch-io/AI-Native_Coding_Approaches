...
def summarize_expenses(records: Iterable[Mapping[str, Any]], *, start: str | datetime.date | None=None, end: str | datetime.date | None=None, strict: bool=False) -> ExpenseSummary
```
